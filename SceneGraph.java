...
public class SceneGraph extends JPanel {
	...
	private void createWorld() {
		...
		Triangle_1.setScale(0.4, 1.2).setTranslation(0, -2).setColor(Color.BLUE);
		Triangle_2.setScale(0.3, 1).setTranslation(-2.25, 0.5).setColor(new Color(140, 10, 150));
		Triangle_3.setScale(0.2, 0.8).setTranslation(1.5, 1).setColor(Color.GREEN);
		...
		Polygon_1.setScale(0.15, 0.15).setTranslation(-0.889, -0.42);
		Polygon_2.setScale(0.15, 0.15).setTranslation(0.899, -1.189);
		Polygon_3.setScale(0.12, 0.12).setTranslation(-3, 1.825);
		Polygon_4.setScale(0.12, 0.12).setTranslation(-1.4, 1.18);
		Polygon_5.setScale(0.1, 0.1).setTranslation(0.83, 2.07);
		Polygon_6.setScale(0.1, 0.1).setTranslation(2.16, 1.52);
	...
	public void updateFrame() {
		...
		Polygon_1.setRotation(frameNumber*0.60); 
		Polygon_2.setRotation(frameNumber*0.60); 
		Polygon_3.setRotation(frameNumber*0.06); 
		Polygon_4.setRotation(frameNumber*0.60); 
		Polygon_5.setRotation(frameNumber*0.60); 
		Polygon_6.setRotation(frameNumber*0.60); 
